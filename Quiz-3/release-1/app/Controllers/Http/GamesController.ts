  ...
  public async update({ request, response }: HttpContextContract) {
    try {
      ...
      if (request.body().title != null) {
        game[0].title = request.body().title;
      }
      if (request.body().gameplay != null) {
        game[0].gameplay = request.body().gameplay;
      }
      if (request.body().release_date != null) {
        game[0].release_date = request.body().release_date;
      }
      if (request.body().categories != null) {
        game[0].categories_id = request.body().categories_id;
      }
